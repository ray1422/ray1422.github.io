...
import '../css/falling_snow_overlay.css'
import ShaderProgram from '../utils/ShaderProgram.js'
import snowIMG from '../assets/images/textures/snow.png'
...
function update() {
    ...
    // async load image and encode to base64
    ...
    const snowflake = snowIMG
    // const holder = this // document.querySelector('.falling_snow_overlay')
    const count = 7000
    holder.style.top = 0
...
export default FallingSnowOverlay;
